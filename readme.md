...
1. In Drupal, locate the current year's page (e.g., “HFC Data Hub”).
2. Use the clone option to duplicate it.
3. Update the page title and URL alias to reflect the new year (e.g., `2024 Data Hub`).
4. Update the HFC Data Hub page as described below.
